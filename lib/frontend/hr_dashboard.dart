...
import 'package:payroll/frontend/hr_leave_requests.dart';
...
class HrDashboardScreen extends StatelessWidget {
  ...
  Widget _buildActionRow(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _buildActionItem(Icons.person_add_alt_1_outlined, 'Add Staff', null),
        ...
        _buildActionItem(Icons.access_time, 'Timesheets', null),
